...
print(len(validation['features']))
print(len(validation['labels']))
print(len(test2['features']))
print(len(test2['labels']))
...
with tf.Session() as sess:
    ...
    print_test_accuracy(sess, validation['features'], validation['labels'], one_hot_test_labels)
